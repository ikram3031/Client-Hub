...
import { Project, DocItem } from "@/lib/api";
...
// Lightweight documentation and activity logs sidebar navigation
          ...
          <div className="space-y-0.5">
            ...
            >
              <div className="flex items-center space-x-2.5 truncate">
                ...
                <span className="truncate text-xs">AI Action Logs</span>
              </div>
            </button>
          </div>
        </div>
